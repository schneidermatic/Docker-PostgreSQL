...
3. Switch into the 'Docker-PostgreSQL/stack' folder
...
1. Install Python Libraries
        ...
        $ cd $HOME/Docker-PostgreSQL/resources/share/scripts
        $ python -m venv venv
        $ . ./venv/bin/activate
        $ pip install -r ./requirements.txt

## DATABASE
1. Run the crtdb.py script that installs the Northwind Database.
